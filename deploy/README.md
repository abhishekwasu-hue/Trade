...
पण आता `trade_monitor.py` स्वतःच आतून, प्रत्येक invocation मध्ये, दर ~15 सेकंदांनी (डीफॉल्ट
`--interval-seconds 15` — सुरुवातीला 20 होतं, वापरकर्त्याने पुढे आणखी घट्ट केलं) 60-सेकंद cron
window च्या आत (`--loop-seconds 50`) पुन्हा-पुन्हा तपासत राहते — म्हणजे प्रत्यक्ष SL/Target तपासणी
