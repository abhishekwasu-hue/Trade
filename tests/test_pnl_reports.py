...
--------------------------------
pnl_reports.generate_pnl_report() — charges.py चं नवीन (STT/Exchange/SEBI/Stamp/GST सकट) breakdown
...
class TestGeneratePnlReportChargesBreakdown:
    def test_breakdown_present_and_matches_total_charges(self, temp_db):
        ...
        assert breakdown["stt"] > 0  # SELL order वर STT लागलाच पाहिजे
        assert breakdown["stamp_duty"] > 0  # BUY order वर Stamp Duty
