...
def fetch_candles(access_token, symbol, current_spot, interval="30minute", lookback_days=400):
    ...
    try:
        ...
        # प्रत्येक इंटरव्हलसाठी एका API कॉलमध्ये सुरक्षितपणे किती दिवस मागवायचे — Upstox च्या अधिकृत
        # दस्तऐवजानुसार (V3 API): 1-15 मिनिट रेंजसाठी एका कॉलमध्ये जास्तीत जास्त फक्त १ महिना (~28-30
        # दिवस) परवानगी आहे, त्यापेक्षा जास्त मागितल्यास API चूक देतो. आधी 15minute साठी 60 दिवस मागवत
